...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['user'] = $this->db->get_where('tbl_user', ['nip' => $this->session->userdata('nip')])->row_array(); //row_array untuk mengambil data sebaris
        //echo 'Selamat datang user '. $data['user']['name'];  validasi memanggil sesson menampilkan nama si login

        $data['menu'] = $this->db->get('tbl_menu')->result_array(); // select * from user_menu
