            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('data/addjberkas'); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="id_jenis_berkas" placeholder="ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nama_berkas" class="col-sm-2 col-form-label">Nama Berkas</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_berkas" placeholder="Nama Berkas"></input>
                                    </div>
                                </div>
