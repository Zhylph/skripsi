            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('data/editjberkas'); ?>" method="post" enctype="multipart/form-data">
                                <!--form_open_multipart untuk upload foto bawaan CI, harus diarahkan ke controler-->
                                <input type="hidden" name="id_jenis_berkas" value="<?php echo $jenisb->id_jenis_berkas ?>" />

                                <div class="form-group">
                                    <label for="nama_berkas">Nama Berkas</label>
                                    <input class="form-control <?php echo form_error('nama_berkas') ? 'is-invalid' : '' ?>" type="text" name="nama_berkas" value="<?php echo $jenisb->nama_berkas ?>" />
