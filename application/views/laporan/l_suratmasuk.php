...
<html><head>
    ...
    <h6 class="status">Laporan Data Surat Masuk</i></h6>
    <table width="100%" border="1" class="center">
        ...
        foreach ($berkas as $b) : ?>
            <tr>
                <td align="center"><?= $b['no_surat']; ?></td>
                <td align="center"><?= $b['perihal']; ?></td>
                <td align="center"><?= date('d F Y', strtotime($b['tanggal_surat'])); ?></td>
                <td align="center"><?= date('d F Y', strtotime($b['tanggal_diterima'])); ?></td>
                <td align="center"><?= $b['asal_surat']; ?></td>
                <td align="center"><?= $b['tujuan_surat']; ?></td>
            </tr>
