...
<html><head>
    ...
    <h6 class="status">Laporan Data Berkas</i></h6>
    <table width="100%" border="1" class="center">
        ...
        foreach ($berkas as $b) : ?>
            ...
            <tr>
                ...
                <td align="center"><?= $b['nip']; ?></td>
                <td align="center"><?= $b['nama_pegawai']; ?></td>
                <td align="center"><?= $b['nama_berkas']; ?></td>
                <td align="center"><?= tanggal('d F Y', $b['tanggal_upload']); ?></td>
            </tr>
